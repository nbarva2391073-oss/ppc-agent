import requests
from business_report import get_access_token, wait_for_report, download_and_parse, SP_API_BASE, MARKETPLACE_IDS

market = "USA"
token = get_access_token(market)

# Точно один день - 2026-09-05, той самий що падав у продакшн-коді
payload = {
    "reportType": "GET_SALES_AND_TRAFFIC_REPORT",
    "dataStartTime": "2026-09-05T00:00:00Z",
    "dataEndTime": "2026-09-05T23:59:59Z",
...
if document_id:
    ...
    print(f"Записів за 05.09 (один день): {len(records)}")
    if records:
